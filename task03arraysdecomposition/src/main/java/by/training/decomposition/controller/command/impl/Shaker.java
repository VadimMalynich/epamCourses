...
public class Shaker implements Command {
    private static final Logger logger = LogManager.getLogger(Shaker.class);
    ...
    public String execute(String request) {
        ...
        ArraySortingService shakerSort = serviceFactory.getShakerSort();
        FilesOperationsArrayService filesOperations = serviceFactory.getFilesOperationsArrayService();
        String response = null;
        try {
            shakerSort.sort(array, isIncreasing);
            File file = new File("./src/main/resources/sortingresults/shakerResult.txt");
