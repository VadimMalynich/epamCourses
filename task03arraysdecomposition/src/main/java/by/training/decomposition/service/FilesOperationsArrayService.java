...
public interface FilesOperationsArrayService {
    /**
     ...
     */
    void createFromFile(Array array, File f) throws ServiceException;
     ...
     * @throws ServiceException
     */
    String writeSortingResults(Array array, File f) throws ServiceException;
}
