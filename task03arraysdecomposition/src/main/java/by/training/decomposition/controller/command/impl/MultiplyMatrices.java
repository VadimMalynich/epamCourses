...
public class MultiplyMatrices implements Command {
    private static final Logger logger = LogManager.getLogger(MultiplyMatrices.class);
    ...
    public String execute(String request) {
        ...
        columns = Integer.parseInt(request.substring(request.lastIndexOf(' ') + 1));
        ...
        try {
            result = matrixOperationsService.multiply(matrixP, matrixQ);
