...
public class BinaryMerge implements Command {
    private static final Logger logger = LogManager.getLogger(BinaryMerge.class);
    ...
    public String execute(String request) {
        ...
        ArraySortingService binaryMerge = serviceFactory.getBinaryMergeSort();
        FilesOperationsArrayService filesOperations = serviceFactory.getFilesOperationsArrayService();
        String response = null;
        try {
            binaryMerge.sort(array, isIncreasing);
            File file = new File("./src/main/resources/sortingresults/binaryMergeResult.txt");
