...
public class DOMParseXML implements ConsoleCommand {
    private static final Logger userLogger = LogManager.getLogger(DOMParseXML.class);
    ...
    public void execute(String request) {
        try {
            ...
            AbstractPostcardsBuilder postcardsBuilder = PostcardBuilderFactory.createPostcardBuilder("DOM");
