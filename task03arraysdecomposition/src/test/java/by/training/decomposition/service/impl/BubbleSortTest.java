...
public class BubbleSortTest {
    ...
    public Object[][] createDataForSortUp() {
        return new Object[][]{
    ...
    public Object[][] createDataForSortDown() {
        return new Object[][]{
    ...
    @Test(description = "Positive scenario of bubble sorting from min to max value", dataProvider = "testSortToHighProvider")
    public void testSortToHigh(int[] arr, int[] res) throws ServiceException {
        Array actual = new Array(arr);
        Array result = new Array(res);
        bubbleSort.sort(actual, true);
        assertEquals(actual, result);
    }

    @Test(description = "Positive scenario of bubble sorting from max to min value", dataProvider = "testSortToLowProvider")
    ...
    @Test(description = "Negative scenario of bubble sorting when array has length < 2",
            expectedExceptions = ServiceException.class,
            expectedExceptionsMessageRegExp = "Array size is less or equal 1. Bubble sort impossible to apply",
